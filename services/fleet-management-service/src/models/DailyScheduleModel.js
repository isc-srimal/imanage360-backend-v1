...
const DailyScheduleModel = sequelize.define(
  "tbl_daily_schedule",
  {
    schedule_id: {
      type: DataTypes.INTEGER,
...
DailyScheduleModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});
EmployeeModel.hasMany(DailyScheduleModel, {
  foreignKey: "employeeId",
  as: "schedules",
});

DailyScheduleModel.belongsTo(EquipmentModel, {
  foreignKey: "serial_number",
  as: "equipment",
});
EquipmentModel.hasMany(DailyScheduleModel, {
  foreignKey: "serial_number",
  as: "schedules",
});

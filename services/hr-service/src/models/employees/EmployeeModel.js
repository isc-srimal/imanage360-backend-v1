...
const WorkExperienceModel = require("./WorkExperienceModel");
const PayrollDetailsModel = require("./EmployeePayrollModel");
const CertificationsModel = require("./CertificationsModel");
const AcademicQualificationsModel = require("./AcademicQualificationsModel");
const EmployeeContractModel = require("./EmployeeContractModel");
...
EmployeeModel.hasMany(FamilyDetailsModel, {
  foreignKey: "employeeId",
  as: "familyDetails",
  onDelete: "CASCADE",
});

FamilyDetailsModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

EmployeeModel.hasMany(WorkExperienceModel, {
  foreignKey: "employeeId",
  as: "workExperience",
  onDelete: "CASCADE",
});

WorkExperienceModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

EmployeeModel.hasMany(PayrollDetailsModel, {
  foreignKey: "employeeId",
  as: "payrollDetails",
  onDelete: "CASCADE",
});

PayrollDetailsModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

EmployeeModel.hasMany(CertificationsModel, {
  foreignKey: "employeeId",
  as: "certifications",
  onDelete: "CASCADE",
});

CertificationsModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

EmployeeModel.hasMany(AcademicQualificationsModel, {
  foreignKey: "employeeId",
  as: "academicQualifications",
  onDelete: "CASCADE",
});

AcademicQualificationsModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

EmployeeModel.hasMany(EmployeeContractModel, {
  foreignKey: "employeeId",
  as: "employeeContracts",
  onDelete: "CASCADE",
});

EmployeeContractModel.belongsTo(EmployeeModel, {
  foreignKey: "employeeId",
  as: "employee",
});

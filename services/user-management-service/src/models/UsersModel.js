...
UsersModel.belongsTo(UserTypesModel, {
  foreignKey: "user_type_uid",
  as: "user_types",
});

UsersModel.belongsTo(OrganizationModel, {
  foreignKey: "organization_uid",
  as: "organizations",
});

UsersModel.belongsTo(TenantsModel, {
  foreignKey: "tenant_uid",
  as: "tenants",
});

UsersModel.belongsTo(BranchModel, {
  foreignKey: "branch_uid",
  as: "branches",
});
